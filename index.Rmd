...
* A **random forest** model using **rpart** method and **2-fold cross validation** in train function of caret package (**pml_modfit_rf**). For this model I decided to use just a 2-fold cross validation aiming to reduce computational time if reviewers will decide to run my code.
