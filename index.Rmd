...
For predicting proper execution of exercise I fitted a **random forest** model using **rf** method and **2-fold cross validation** in train function of caret package (**pml_modfit_rf**).
