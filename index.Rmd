...
Model was trained and evaluated splitting **pml_training** into a train set with 60% of cases (named **training**) and a test set with remaining 40% (named **testing**). Test set was used for bulding confusion matrix and estimating out of sample error (accuracy). Parallel computing was allowed.
